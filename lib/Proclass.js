		...
		for (var name in prototype) {
			...
			var toCall = !isFunction ? prototype[name] : (function(name, fnc, addParent){
				return function() {
					...
					for (var proName in _protected) {
						temp[proName] = this[proName];
						this[proName] = _protected[proName];
					}
					...
					for (var proName in _protected) {
						...
						if (this[proName] !== _protected[proName]) {
							_protected[proName] = this[proName];
						}
						// Set this value back to previous
						this[proName] = temp[proName];
					}
